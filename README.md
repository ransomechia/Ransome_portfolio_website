...
- Creating some html and css file 
...
sh
  cd my-folder
  git clone https://github.com/ransomechia/Ransome_portfolio_website.git
...
- GitHub: [@Ransomechia](https://github.com/Ransomechia/Hello-Codegisoft Academy.git)
...
- add more figma design
- Implement some functions such as popup function etc
